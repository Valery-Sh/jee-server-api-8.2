...
public abstract class WebModulesNodeFactory implements NodeFactory {
     ...
     * must be recognized as a Jetty server.
     *
     * @param project
    ...
    protected Node getNodeDelegate(Project serverProj) throws DataObjectNotFoundException {
        return DataObject.find(serverProj.getProjectDirectory())
                .getNodeDelegate();
    }
