...
//        return serverProject.getProjectDirectory().getFileObject(base + "/build.xml");
    ...
    protected String getStartJar(Project serverProject) {
        InstanceProperties ip = BaseUtil.managerOf(serverProject.getLookup()).getInstanceProperties();
        return ip.getProperty(BaseConstants.HOME_DIR_PROP) + "/start.jar";

    }

    protected Properties getProps(Project serverProject) {
        BaseDeploymentManager manager = BaseUtil.managerOf(serverProject.getLookup());
    ...
    public Properties getProfileProperties(Project serverProject) {
        ...
        String profile_args = BaseUtil.getProfileArgs(BaseUtil.managerOf(serverProject.getLookup()));
