 ...
 * @author V. Shyshkin
 */
public class HotAnyFolderChildNode extends FilterNode {
     ...
     */
    protected HotAnyFolderChildNode(Project serverProj, Object key) throws DataObjectNotFoundException {
        super(getNodeByKey(serverProj,key));
    }
